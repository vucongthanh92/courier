...
func InitializeContainer(appCfg *config.AppConfig, readDb *database.GormReadDb, writeDb *database.GormWriteDb, redisClient redis.Client) *api.ApiContainer {
	...
	tokenUseCaseI := token.InitTokenUseCase(managerTxn, auditLogServiceI, jwtSignerI, refreshTokenCommandRepoI)
	authServiceI := auth.InitAuthUseCase(managerTxn, auditLogServiceI, outboxServiceI, userQueryRepoI, userCommandRepoI, authCredentialCommandRepoI, authCredentialQueryRepoI, emailVerificationCommandRepoI, emailVerificationQueryRepoI, refreshTokenCommandRepoI, refreshTokenQueryRepoI, tokenDenylistI, tokenUseCaseI)
